...
The single-cycle waveforms in `wavetables.js` are selected from
[Adventure Kid Wave Forms](https://github.com/KristofferKarlAxelEkstrand/AKWF-FREE),
released under [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/).

Selected source waveforms:
...
## Drum and transition samples

The embedded sounds in `audio-assets.js` are CC0 sounds published on
[Freesound](https://freesound.org/). The project uses the high-quality preview
files so the experience remains self-contained when opened from `file://`.

| Asset | Creator | Freesound page |
| --- | --- | --- |
| Dubstep Kick 4 - Clean | mrbossosity | https://freesound.org/s/774957/ |
